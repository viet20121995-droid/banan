/* Firebase Cloud Messaging service worker — handles web push while the
   Banan tab is in the background or closed. Must live at the web root. */
...
messaging.onBackgroundMessage(function (payload) {
  ...
  self.registration.showNotification(n.title || 'Banan', {
    body: n.body || '',
...
// Click → focus an existing tab or open the deep link.
